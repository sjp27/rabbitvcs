...
class AltDiff(InterfaceView, GtkContextMenuCaller):
    """
    ...
    def __init__(self, paths, base_dir=None, message=None):
        ...
        """
        InterfaceView.__init__(self, "altdiff", "AltDiff")
    ...
    def on_toggle_show_unversioned_toggled(self, widget, *args):
        ...
        # Save this preference for future altdiffs.
...
classes_map = {
    rabbitvcs.vcs.VCS_SVN: SVNAltDiff,
    rabbitvcs.vcs.VCS_GIT: GitAltDiff
}
